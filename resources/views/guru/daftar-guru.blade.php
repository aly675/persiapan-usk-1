...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-8">
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <!-- Tombol Tambah -->
            <div class="mb-6">
                <a href="{{ route('guru.tambah-guru-page') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition duration-300">
                    + Tambah Guru
                </a>
            </div>
                        ...
                        @forelse($datas as $key => $data)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('guru.edit-guru-page', $data->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>

                                    <!-- Tombol Delete (pakai form) -->
                                    <form action="{{ route('guru.delete-guru', $data->id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                        @csrf
                                        @method('DELETE')
