...
<body class="bg-gray-100">
    ...
    <nav class="bg-gray-800 text-white p-4 mb-8 shadow-md">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div>
                ...
                <a href="{{ route('guru.daftar-guru-page') }}" class="px-3 py-2 rounded bg-gray-700">Data Guru</a>
                <!-- TAMBAH LINK SISWA -->
    ...
    <div class="container mx-auto p-8">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <h1 class="text-3xl font-bold mb-6 text-gray-800">Edit Data Guru</h1>
            ...
            <!-- Form Edit -->
            <form action="{{ route('guru.edit-guru', $data->id) }}" method="POST" class="space-y-6">
                @csrf
                ...
                <!-- NIP -->
                <div>
                    <label for="nip" class="block text-sm font-medium text-gray-700">NIP (Harus 10 digit)</label>
                    <input type="number" name="nip" id="nip" value="{{ old('nip', $data->nip) }}" required
                           class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                </div>
                ...
                <div class="flex justify-end space-x-4">
                    <a href="{{ route('guru.daftar-guru-page') }}" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300">
                        Batal
                    </a>
